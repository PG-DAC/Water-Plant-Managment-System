	...
	public String changePassword(@RequestParam("oldPassword") String oldPassword,
		...
		try {
			...
			session.setAttribute("message",
					new UserException("Something Went Wrong.." + e.getMessage(), "alert-error"));
...
//Order Manage-------------------------------------------------------------------------------------------	     
	 ...
	 orderService.deleteOrderById(id); return "user/user_dashboard"; }
...
// cart Mapping-------------------------------------------------------------------------
	...
	public String addOrderGet(Model m) {
		...
		return "user/addOrders";
	}

	// Order adding process post
	@RequestMapping(value = "/adding_orders", method = RequestMethod.POST)
	public String productAddPost(@ModelAttribute("orders") Orders orders, HttpSession session) {
