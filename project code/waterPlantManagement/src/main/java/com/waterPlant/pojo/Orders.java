...
public class Orders {
	...
	public Orders(int id, int user_id, int product_id, double total, int quantity, String shippingAddress,
			String shippingDate, User user) {
		super();
		this.id = id;
